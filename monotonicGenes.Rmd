...
An interesting chart showing the raw values of gene expression for the three melanin and Vitamin D genes top ranked by genecards.org was created and shared on [Tableau Public Server](https://public.tableau.com/profile/janis5126#!/vizhome/SunGenesDemographicsRawValues/SunGenesDemographics?publish=yes).
...
[All genes as a bar chart of fold change values](https://public.tableau.com/profile/janis5126#!/vizhome/vitMinSterAllGenesBarchart/vitMinSterAllGenesBarchart?publish=yes) then a scatter with raw values as a comparision with age and gender and sample ID:
![barchart all Vitamin Genes' Fold Change Values](./images/vitBarAll.png)



[A scatter plot by age, gender, and raw sample ID values](https://public.tableau.com/profile/janis5126#!/vizhome/vitaminCovidScatterAgeGender/vitaminCovidScatterAgeGender?publish=yes) with the gene and gene summary information:
...
[bar chart monotonically increasing vitamin genes](https://public.tableau.com/profile/janis5126#!/vizhome/vitMinSterMonDecrAllGenesBarchart/vitMinSterMonDecrGenesBarchart?publish=yes):
![bar chart monotonically increasing vitamin genes](./images/vitBarMI.png)

[scatter plot of the monotonically increasing vitamin genes](https://public.tableau.com/profile/janis5126#!/vizhome/vitaminCovidScatterAgeGenderMonDecr/vitaminCovidScatterAgeGenderMonDecr?publish=yes):
![scatter plot of the monotonically increasing vitamin genes](./images/vitScMI.png)


[bar chart of those vitamin genes that are monotonically decreasing](https://public.tableau.com/profile/janis5126#!/vizhome/vitMinSterMonIncrAllGenesBarchart/vitMinSterMonIncrGenesBarchart?publish=yes):
![bar chart of those vitamin genes that are monotonically decreasing](./images/vitBarMD.png)

[Scatter plot of those vitamin genes monotonically decreasing](https://public.tableau.com/profile/janis5126#!/vizhome/vitaminCovidScatterAgeGenderMonIncr/vitaminCovidScatterAgeGenderMonIncr?publish=yes):
