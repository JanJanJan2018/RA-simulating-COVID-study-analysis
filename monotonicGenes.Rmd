...
precisionRecallAccuracy <- function(df){
 ...
 class4a <- as.character(paste(classes[4]))
  ...
  # we don't need the actual tp and np values not the predicted as we have now
  # aTP1 <-length(Class1$type)
  # aTP2 <- length(Class2$type)
  # aTP3 <- length(Class3$type)
  # aTP4 <- length(Class4$type)
  # 
  # aTN1 <- length(notClass1$type)
  # aTN2 <- length(notClass2$type)
  # aTN3 <- length(notClass3$type)
  # aTN4 <- length(notClass4$type)
  # 
  ...
  print('precision, recall, accuracy for ')
  print(class1a)
  print(c(p1,r1,ac1))
  print('precision, recall, accuracy for ')
  print(class2a)
